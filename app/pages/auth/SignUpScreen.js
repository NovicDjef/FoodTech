    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
            <Text style={styles.text_header}>S'incrire Maintenant!</Text>
        </View>
        <Animatable.View 
        ...
        >
            <ScrollView>
            <Text style={styles.text_footer}>Prenom / Pseudo</Text>
            ...
            <View style={styles.textPrivate}>
                ...
                <Text style={[styles.color_textPrivate, {fontWeight: 'bold'}]}>{" "}Terme et service</Text>
