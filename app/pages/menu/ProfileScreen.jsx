...
import { loadUserDataFromStorage, loadUserDataPhoneFromStorage } from '../../redux/action/authActions';
...
export default function ProfileScreen({navigation}) {
  ...
  const numero_telephone = useSelector(state => state.authReducer.numero_telephone)
  ...
  useEffect(() => {
    ...
    console.warn("telephone:", numero_telephone)
    console.warn("wallet :", walletBalance)
    dispatch(loadUserDataFromStorage());
    dispatch(loadUserDataPhoneFromStorage());
  }, [dispatch])
        ...
        <View style={styles.section}>
          ...
          <View style={styles.profile}>
            <Image
              ...
              source={require('../../assets/novic.png')}
            ...
            <View style={styles.profileBody}>
              ...
              <Text style={styles.profileHandle}>(+237) {numero_telephone}</Text>
            </View>
            <TouchableOpacity 
            onPress={submit}
            style={{
